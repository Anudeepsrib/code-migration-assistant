...
from skills.code_migration.core.compliance import AuditReporter
...
class TestAuditReporter:
    ...
    def test_soc2_report_generation(self, temp_project_dir):
    ...
    def test_gdpr_report_generation(self, temp_project_dir):
    ...
    def test_hipaa_report_generation(self, temp_project_dir):
    ...
    def test_security_audit_report_generation(self, temp_project_dir):
    ...
    def test_report_export_json(self, temp_project_dir):
    ...
    def test_report_export_html(self, temp_project_dir):
    ...
    def test_report_export_invalid_format(self, temp_project_dir):
    ...
    def test_date_range_filtering(self, temp_project_dir):
    ...
    def test_default_date_ranges(self, temp_project_dir):
    ...
    def test_evidence_collection(self, temp_project_dir):
...
class TestAuditReporterEdgeCases:
    ...
    def test_boundary_date_ranges(self, temp_project_dir):
