...
from skills.code_migration.core.compliance import PIIDetector
...
""")
    ...
    def test_email_detection(self, temp_project_dir):
    ...
    def test_phone_detection(self, temp_project_dir):
    ...
    def test_ssn_detection(self, temp_project_dir):
    ...
    def test_credit_card_detection(self, temp_project_dir):
    ...
    def test_phi_detection(self, temp_project_dir):
    ...
    def test_directory_scan(self, temp_project_dir):
    ...
    def test_safe_file_no_findings(self, temp_project_dir):
    ...
    def test_compliance_report_generation(self, temp_project_dir):
    ...
    def test_context_generation(self, temp_project_dir):
    ...
    def test_recommendation_generation(self, temp_project_dir):
...
""")
    ...
    def test_malformed_pii_patterns(self, temp_project_dir):
    ...
    def test_international_phone_detection(self, temp_project_dir):
    ...
    def test_ip_address_detection(self, temp_project_dir):
    ...
    def test_date_pattern_detection(self, temp_project_dir):
    ...
    def test_unicode_pii_handling(self, temp_project_dir):
...
""")
    ...
    def test_nested_pii_in_strings(self, temp_project_dir):
